# libzu for darwin/amd64

The static library the Go client links against on this platform, built from [tamnd/zu](https://github.com/tamnd/zu) for `x86_64-apple-darwin`.
