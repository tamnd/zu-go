# libzu for darwin/arm64

The static library the Go client links against on this platform, built from [tamnd/zu](https://github.com/tamnd/zu) for `aarch64-apple-darwin`.
